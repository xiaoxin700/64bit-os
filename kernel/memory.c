...
void init_memory() {
    ...
    color_printk(ORANGE, BLACK, "OS Can Used Total 2M PAGEs:%#0x010x=%010d\n", TotalMem, TotalMem);
    ...
    for (i = 0; i <= memory_management_struct.e820_length; i++) {
        ...
        //init zone
        z = memory_management_struct.zones_struct + memory_management_struct.zones_size;  // when i=0, zones_size=0
